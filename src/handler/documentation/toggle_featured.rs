...
// Whether a doc shows up in the docs section on the home page — the only
// field the dashboard's documentation list needs to edit in place, so this
// stays a dedicated toggle rather than a general-purpose PATCH.
pub async fn task(
    req: HttpRequest,
